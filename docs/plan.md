...
- [ ] **5.1 Тесты фронтенда** (Пропущено по решению, так как не требуется ТЗ)
...
- [x] **5.3 README.md** ✅
  ...
  - [x] Стек и обоснование выбора
  - [x] Инструкция по запуску: `docker-compose up`
  - [x] Инструкция по локальной разработке
